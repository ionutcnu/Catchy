...
- Removed dead code stubs (rateLimit, ignoreRules, resource/network error type placeholders)
- Corrected documentation — history size, error grouping, session scope, permissions
